...
/// <summary>
/// Provides asynchronous extension members for pattern matching on <see cref="Option{T}"/> instances using <see cref="Task{TResult}"/>.
/// </summary>
public static class MatchTaskExtension
{
    ...
    {
        /// <summary>
        /// Awaits the option task and dispatches to the synchronous Some/None handlers.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="self"/>, <paramref name="onSome"/>, or <paramref name="onNone"/> is <see langword="null"/>.</exception>
        public async Task<U> MatchAsync<U>(Func<T, U> onSome, Func<U> onNone)
            where U : notnull
        {
        ...
        /// <summary>
        /// Awaits the option task and dispatches to the asynchronous Some/None handlers.
        /// </summary>
        /// <typeparam name="U">The result type returned by both branches.</typeparam>
        ...
        public async Task<U> MatchAsync<U>(Func<T, Task<U>> onSome, Func<Task<U>> onNone)
            where U : notnull
        {
            ArgumentNullException.ThrowIfNull(self);
            ArgumentNullException.ThrowIfNull(onSome);
