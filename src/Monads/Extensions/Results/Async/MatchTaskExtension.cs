...
/// <summary>
/// Provides asynchronous extension members for pattern matching on <see cref="Result{T, E}"/> instances.
/// </summary>
public static class MatchTaskExtension
{
        ...
        where E : notnull
    {
        ...
        /// </remarks>
        public async Task<U> MatchAsync<U>(Func<T, U> onOk, Func<E, U> onErr)
            where U : notnull
        {
        ...
        /// </remarks>
        public async Task<U> MatchAsync<U>(Func<T, Task<U>> onOk, Func<E, Task<U>> onErr)
            where U : notnull
        {
            ArgumentNullException.ThrowIfNull(self);
            ArgumentNullException.ThrowIfNull(onOk);
