...
/// <summary>
/// Provides asynchronous extension methods for mapping error values within <see cref="Result{T, E}"/> instances using <see cref="ValueTask{TResult}"/>.
/// </summary>
public static class MapErrValueTaskExtension
{
    ...
    public static async ValueTask<Result<T, F>> MapErrAsync<T, E, F>(
