...
/// <summary>
/// Provides asynchronous extension methods for mapping values within <see cref="Result{T, E}"/> instances using <see cref="ValueTask{TResult}"/>.
/// </summary>
public static class MapValueTaskExtension
{
    ...
    /// </remarks>
    public static async ValueTask<Result<U, E>> MapAsync<T, E, U>(
