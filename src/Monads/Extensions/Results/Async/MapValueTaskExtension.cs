...
/// <summary>
/// Provides asynchronous extension members for mapping values within <see cref="Result{T, E}"/> instances using <see cref="ValueTask{TResult}"/>.
/// </summary>
public static class MapValueTaskExtension
{
    ...
    {
        /// <summary>
        /// Asynchronously maps the value of a <see cref="Result{T, E}"/> contained within a <see cref="ValueTask{TResult}"/>
        ...
        /// <returns>
        /// A <see cref="ValueTask{TResult}"/> that produces a <see cref="Result{U, E}"/>,
        ...
        /// </remarks>
        public async ValueTask<Result<U, E>> MapAsync<U>(Func<T, U> operation)
            where U : notnull
        {
        ...
        /// </remarks>
        public async ValueTask<Result<U, E>> MapAsync<U>(Func<T, ValueTask<U>> operation)
            where U : notnull
        {
            ArgumentNullException.ThrowIfNull(operation);
