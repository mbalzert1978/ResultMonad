...
/// <summary>
/// Provides asynchronous extension members for mapping values within <see cref="Result{T, E}"/> instances using <see cref="Task{TResult}"/>.
/// </summary>
public static class MapTaskExtension
{
        ...
        where E : notnull
    {
        ...
        /// </remarks>
        public async Task<Result<U, E>> MapAsync<U>(Func<T, U> operation)
            where U : notnull
        {
        ...
        /// </remarks>
        public async Task<Result<U, E>> MapAsync<U>(Func<T, Task<U>> operation)
            where U : notnull
        {
            ArgumentNullException.ThrowIfNull(operation);
            ...
            return await self.MatchAsync(
                    ...
                    err => Task.FromResult(Result.Err<U, E>(err))
                )
                .ConfigureAwait(false);
        }
    }
