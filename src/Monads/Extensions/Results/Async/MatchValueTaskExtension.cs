...
/// <summary>
/// Provides asynchronous extension members for pattern matching on <see cref="Result{T, E}"/> instances using <see cref="ValueTask{TResult}"/>.
/// </summary>
public static class MatchValueTaskExtension
{
        ...
        where E : notnull
    {
        ...
        /// </remarks>
        public async ValueTask<U> MatchAsync<U>(Func<T, U> onOk, Func<E, U> onErr)
            where U : notnull
        {
